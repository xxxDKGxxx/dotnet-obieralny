...
namespace LoanHub.Backend.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260113211909_AdjustedApplicationAggregate")]
    partial class AdjustedApplicationAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoanHub.Backend.Core.EntityAggregates.ApplicationAggregate.Application", b =>
                {
                    b.HasOne("LoanHub.Backend.Core.EntityAggregates.OfferAggregate.Offer", "Offer")
                        .WithMany()
                        .HasForeignKey("OfferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LoanHub.Backend.Core.EntityAggregates.UserAggregate.User", "User")
                        .WithMany()
